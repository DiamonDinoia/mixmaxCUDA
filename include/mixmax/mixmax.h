/*
 *  PLEASE NOTE - THIS IS AN IMPLEMENTATION OF THE MIXMAX GENERATOR
 *  EXPLICITLY FOR THE PURPOSE OF GPU PERFORMANCE MEASUREMENTS TO ACCOMPANY
 *  THE PAPER IN TBA PROCEEDINGS TBA
 *  Talk: CHEP 2023 Fast, high-quality pseudo random number generators for heterogeneous computing
 *  https://indico.jlab.org/event/459/contributions/11828/
 *  
 *  Copyright 2023 Marco Barbone
 *
 *  original implementation found in mixmax.hpp source: https://mixmax.hepforge.org/
 *
